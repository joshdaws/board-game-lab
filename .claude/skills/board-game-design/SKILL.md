...
description: |
  Interactive board game design assistant powered by analysis of the BGG top 125 games.
...
AI-assisted board game design grounded in analysis of the 125 highest-ranked games on BoardGameGeek (February 2026). Every recommendation traces back to proven patterns from real, successful designs.

## Reference Files

| File | When to Load | Contents |
|------|-------------|----------|
| `references/game-index.md` | **Always load first** | Rank, weight, archetype code, primary mechanics for all 125 games |
...
| `games/NN-slug.md` | Deep-dive on specific games (max 3-5 per response) | 125 enriched files in the project root with theme integration, core loops, key design patterns |
